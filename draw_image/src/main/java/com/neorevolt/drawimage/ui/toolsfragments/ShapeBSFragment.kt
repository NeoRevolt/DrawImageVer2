...
import com.neorevolt.drawimage.ui.adapters.ColorPickerAdapter
import com.neorevolt.drawimage.ui.adapters.ColorPickerAdapter.OnColorPickerClickListener
...
class ShapeBSFragment : BottomSheetDialogFragment(), SeekBar.OnSeekBarChangeListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Note(lucianocheng): Move layoutManager to a xml file.
